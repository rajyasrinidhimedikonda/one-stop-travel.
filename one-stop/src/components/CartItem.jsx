...
const CartItem = ({name, price, image, qty}) => {
    ...
    return (
        <div className='w-full p-5 rounded-sm bg-neutral-100 flex flex-col'>
            ...
            <div className='flex flex-col w-full h-full p-2'>
                <h1 className='text-2xl font-bold'>{name} <span className='ml-20 font-normal text-lblue3 text-sm '>{price}</span></h1>
            </div>
            </div>
